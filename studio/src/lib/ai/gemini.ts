...
function buildPrompt(input: ScriptGenerationInput): string {
  ...
  // 첫 슬라이드(후킹) 강제 규칙: 조카가 삼촌에게 묻는 형태
  body +=
    '\n\n# 첫 슬라이드(슬라이드 1, 후킹) 작성 규칙 — 반드시 지킬 것\n' +
    '- principle: "hook"\n' +
    '- speaker: "niece" (조카 — 평범한 30대 직장인/사용자 대변)\n' +
    '- main 텍스트는 반드시 "삼촌," 으로 시작하는 친근한 반말 질문 형태\n' +
    '- 일상에서 누구나 궁금해 할 만한 자연스러운 의문\n' +
    '- 너무 전문적이지 않고, 평범한 사람이 카톡에 갑자기 보낼 법한 톤\n' +
    '- 짧고 임팩트 있게 (~30~40자)\n\n' +
    '예시:\n' +
    '  · "삼촌, 5세대 실비 보험이 뭐야? 나도 바꿔야 해?"\n' +
    '  · "삼촌, 나 암진단비 있는데 암치료비도 따로 필요해?"\n' +
    '  · "삼촌, 나 취직해서 연금 준비할래, 어떤 게 좋아?"\n' +
    '  · "삼촌, 운전자보험 1만 원짜리 충분해?"\n' +
    '  · "삼촌, 부모님 보험 아직 안 만드셨대... 늦었어?"\n\n' +
    '두 번째 슬라이드부터는 "삼촌(uncle)" 화자가 답변하는 흐름으로 자연스럽게 이어가세요.\n' +
    '(하지만 매 슬라이드를 카톡 대화로만 끌고 갈 필요는 없습니다 — 핵심 정보 전달이 우선)';
