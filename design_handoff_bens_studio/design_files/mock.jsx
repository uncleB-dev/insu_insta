...
// Mirrors what would come from app/api routes in real Next.js build.
...
const POSTS = [
  { id: 'p1', title: '암치료비가 비싸다는데 얼마나?', series: 'A', persona: '30s_office',
    status: 'published', updated: '2일 전', slides: 9, hook: '하루 입원비 20만원...' },
  { id: 'p2', title: '1세대 실손 해지하면 진짜 후회한다는 이유', series: 'B', persona: 'parent',
    status: 'draft', updated: '5일 전', slides: 9, hook: '엄마 1세대 실손...' },
  { id: 'p3', title: '이직할 때 보험 어떻게 옮겨야 해?', series: 'C', persona: 'newbie',
    status: 'published', updated: '1주 전', slides: 7, hook: '회사 단체보험 끝나면...' },
  { id: 'p4', title: '신혼 부부 보험 처음부터 다시 짜기', series: 'C', persona: 'newlywed',
    status: 'scheduled', updated: '2주 전', slides: 9, hook: '결혼하면 보험도 합쳐...' },
  { id: 'p5', title: '비급여, 도대체 뭐가 비급여인지', series: 'A', persona: '30s_office',
    status: 'draft', updated: '3주 전', slides: 9, hook: 'MRI 한 번에 80만원...' },
  { id: 'p6', title: '간병보험 vs 간병인지원금 뭐가 다른데?', series: 'B', persona: 'parent',
    status: 'published', updated: '1달 전', slides: 9, hook: '간병보험이라고 해서...' },
  { id: 'p7', title: '치아보험, 진짜 들어야 하는 사람은 누구', series: 'A', persona: '30s_office',
    status: 'published', updated: '1달 전', slides: 7, hook: '임플란트 한 개 200만원...' },
  { id: 'p8', title: '운전자보험 1만원짜리, 진짜 충분할까?', series: 'A', persona: '30s_office',
    status: 'draft', updated: '5주 전', slides: 9, hook: '한 달에 만 원이면...' },
];
...
const PROMPT_BODY = `당신은 한국 보험설계사 "보험삼촌 BEN"의 인스타그램 카드뉴스
...
const LIBRARY_PHOTOS = Array.from({ length: 18 }, (_, i) => ({
  id: 'ph' + i,
  src: `https://picsum.photos/seed/insu${i + 7}/400/400`,
  uses: Math.floor(Math.random() * 8),
  source: i % 3 === 0 ? 'upload' : i % 3 === 1 ? 'unsplash' : 'library',
}));

window.MOCK = {
  SERIES, PERSONAS, PRINCIPLES, SCRIPT_SLIDES, POSTS,
  HASHTAGS, GUARDRAIL_RULES, PROMPT_VERSIONS, PROMPT_BODY, LIBRARY_PHOTOS,
};
